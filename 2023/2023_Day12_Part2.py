...
for line in file_content:
    ...
    expanded_damaged_group_sizes = damaged_group_sizes*5
    for i in range(4):
...
In general if you have 2 possibilities for each of 2 repeating units, you'd have 4 combinations.
If you had 3 poss for 3 units, you'd have 27 combinations.
2 poss for 3 repeating units gives 2^3 = 8 combinations
Therefore if we had 5 repeating units we would need the original number of combinations^5.
